  ...
  return (
    <section className="file-input d-flex flex-column gap-1">
      <div
        {...getRootProps({
          className:
            "dropzone align-items-center py-4 rounded-4 gap-2 d-flex flex-column",
        })}
      >
        <input {...getInputProps()} />
...
const LaporinPage = () => {
  ...
  const [showAccountCreationMessage, setShowAccountCreationMessage] =
    useState(false); // Add this state

  // Check user authentication status (you might need to implement your own logic)
  useEffect(() => {
    if (showAccountCreationMessage) {
      // If the warning message needs to be shown, you can set other states or perform actions here
  ...
  const handleSubmit = async (postForm, { setSubmitting }) => {
    ...
    try {
      ...
      setShowAccountCreationMessage(true); // Show the message after a failed submission
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="warning-message">
        {showAccountCreationMessage && (
          <div className="alert alert-warning" role="alert">
            Anda harus memiliki akun terlebih dahulu untuk mengirim laporan.
          </div>
        )}
      </div>
      <div className="Complaint my-4 d-flex flex-column">
        ...
        {submitSuccess && (
          <div className="alert alert-success mt-4" role="alert">
            <p className="font-weight-bold">Yey, Laporanmu sudah terkirim.</p>
            <br />
            <p>
              Untuk mengetahui tanggapan dari instansi, Anda bisa cek Pesan
              secara berkala. Terima Kasih.
            </p>
          </div>
        )}
                  ...
                  <Form.Group className="forms-g" controlId="name_visibility">
                    ...
                    <div className="mb-1">
                      <Form.Check
                        ...
                        onChange={handleChange}
                        isInvalid={
                          touched.name_visibility && !!errors.name_visibility
                        }
                      />
                      <Form.Check
                        type="radio"
                  ...
                  <Form.Group className="forms-g" controlId="post_visibility">
                    ...
                    <div className="mb-1">
                      <Form.Check
                        ...
                        onChange={handleChange}
                        isInvalid={
                          touched.post_visibility && !!errors.post_visibility
                        }
                      />
                      <Form.Check
                        type="radio"
